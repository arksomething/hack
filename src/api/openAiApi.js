...
const prompts = {
    ...
    "work networks": "You are a professional assistant helping professionals do outreach. You are given a website containing professional data. Your job is to summarize the three most extraordinary things about this individual. This might be what school they went to or some unique accomplishments. KEEP THE OUTPUT SHORT, NO MORE THAN 10 WORDS PER BULLET POINT."
,
    ...
    try {
        const classification = await axios.post('https://api.openai.com/v1/chat/completions', {
            ...
            messages: [
                {
                    role: "system",
                    content: 'You are an agent that takes in website information and outputs the category the websites belong to. These include "microblogging" like Twitter, X, or Bluesky, "work" like Jira or Leetcode, "articles" like Medium sites or the Wall Street Journal, "documentation" which may include code documentation sites, "work networks" such as LinkedIn or email, "education" like Brightspace or Canvas, or “other”. RESPOND WITH ONLY THE CATEGORY. DO NOT INCLUDE THE QUOTES. SAMPLE RESPONSES: work networks, articles'
